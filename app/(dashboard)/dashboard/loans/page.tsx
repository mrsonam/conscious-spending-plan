        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Track money you lent to others. These amounts are deducted from your account balance but do not count as
              spending in your fund categories.
            </p>
          </div>
          <Button
            onClick={() => {
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Money you have lent out and not yet received back</CardDescription>
              </CardHeader>
              <CardContent>
