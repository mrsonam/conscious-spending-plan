    ...
    >
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          sideOffset={4}
          className={cn(
            "z-[310] max-h-[min(320px,70dvh)] w-[var(--radix-select-trigger-width)] overflow-y-auto rounded-xl border border-[rgba(218,226,253,0.12)] bg-[#131b2e] py-1 text-[#dae2fd] shadow-lg",
            contentClassName
          )}
        >
          <SelectPrimitive.Viewport className="p-1">
            {options.map((opt) => (
              <SelectPrimitive.Item
                ...
                className={cn(
                  "relative flex cursor-pointer select-none items-center rounded-md py-2 pl-8 pr-3 text-sm text-[#dae2fd] outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-white/10",
                  itemClassName
                )}
              >
